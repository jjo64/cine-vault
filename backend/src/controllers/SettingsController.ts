...
export const actualizarAuth = async (req: SolicitudAutenticada, res: Response) => {
    ...
    const user_id = req.user!.user_id
    const { password_actual, password_nueva, password_confirmacion }: authActualizar = req.body
...
export const actualizarAvatar = async (req: SolicitudAutenticada, res: Response) => {
    const user_id = req.user!.user_id
