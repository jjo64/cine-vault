...
function FieldError({ children }: { children?: string | null }) {
  ...
  return (
    <div
      style={{ color: "#ff9c9c", fontSize: 11, fontFamily: SANS, marginTop: 4 }}
    >
      {children}
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <main className="settings-main">
          ...
          {sectionTabs.map((section) => (
            <button
              ...
              style={{
                ...
                background:
                  activeSection === section.key ? C.accentGlow : "transparent",
        ...
        {error && (
          <div style={{ color: "#ff9d9d", marginBottom: 10, fontSize: 12 }}>
            {error}
          </div>
        )}
        {successMessage && (
          <div style={{ color: C.accent, marginBottom: 10, fontSize: 12 }}>
            {successMessage}
          </div>
        )}
        ...
        {activeSection === "perfil" && (
          ...
          >
            ...
            <div>
              ...
              <div
                style={{
                  color: usernameStatus === "available" ? C.accent : C.textSoft,
                  fontSize: 11,
                  marginTop: 4,
                }}
              >
        ...
        {activeSection === "seguridad" && (
          ...
          >
            ...
            <div
              style={{
                border: `1px solid ${isTwoFactorEnabled ? C.accentDim : C.border}`,
                background: isTwoFactorEnabled ? C.accentGlow : C.elevated,
                padding: "10px 12px",
                display: "flex",
                alignItems: "center",
                justifyContent: "space-between",
            ...
            >
              <div
                style={{
                  ...
                  letterSpacing: "0.1em",
                  textTransform: "uppercase",
                  color: isTwoFactorEnabled ? C.accent : C.textSoft,
                }}
              >
              ...
              {!isTwoFactorEnabled ? (
                <button
                  ...
                  style={{
                    ...
                    letterSpacing: "0.12em",
                    textTransform: "uppercase",
                    cursor: twoFactorBusy ? "default" : "pointer",
                    fontFamily: SANS,
                  }}
                >
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: "rgba(140,48,48,0.18)",
                      color: "#ff9d9d",
                      padding: "8px 12px",
                      fontSize: 11,
                      letterSpacing: "0.12em",
            ...
            {isTwoFactorEnabled && (
              ...
              >
                ...
                >
                  Usalos si perdés acceso a tu app autenticadora. Cada código
            ...
            <input
              ...
              onChange={(event) =>
                setPasswordForm((prev) => ({
                  ...prev,
                  password_confirmacion: event.target.value,
                }))
              }
              style={{
                width: "100%",
        ...
        {activeSection === "cuenta" && (
          ...
          >
            ...
            {deleteStep > 0 && (
              <div>
                <div
                  style={{ color: C.textSoft, fontSize: 11, marginBottom: 6 }}
                >
      ...
      >
        <button
          ...
          style={{
            border: `1px solid ${C.accentDim}`,
            background: hasUnsavedChanges ? C.accentGlow : "transparent",
            color: hasUnsavedChanges ? C.accent : C.textMuted,
            padding: "10px 14px",
            minWidth: 220,
