          ...
          <div style={{ display: "flex", gap: 4 }}>
            {[1, 2, 3, 4, 5].map((s) => (
              <button
                key={s}
                onClick={() =>
                  onChange("minRating", filters.minRating === s ? 0 : s)
                }
                style={{
                  width: 32,
                  height: 32,
                  background:
                    s <= (filters.minRating || 0)
                      ? C.accentGlow
                      : "transparent",
                  border: `1px solid ${s <= (filters.minRating || 0) ? C.accentDim : C.border}`,
                  fontSize: 16,
                  color: s <= (filters.minRating || 0) ? C.gold : C.textMuted,
                  cursor: "pointer",
                }}
              >
                ★
...
function getDirectorFromDetail(
  crew?: Array<{
    id: number;
    name: string;
    job?: string;
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: hov ? "rgba(212,175,122,0.02)" : "transparent",
      ...
      <div style={{ minWidth: 0 }}>
        ...
        >
          <button
            ...
            style={{
              padding: "12px 18px",
              background: vaulted ? C.accentDim : C.accent,
              color: C.bg,
              border: "none",
              fontFamily: SANS,
              fontSize: 10,
          ...
          <button
            ...
            style={{
              ...
              color: bookmarked ? C.accent : C.textSoft,
              border: `1px solid ${bookmarked ? C.accentDim : C.border}`,
              cursor: "pointer",
              display: "flex",
              alignItems: "center",
              gap: 6,
      ...
      <div>
        ...
        >
          <Link to={`/person/${item.id}`} style={{ textDecoration: "none" }}>
            <span style={{ fontFamily: SERIF, fontSize: 24, color: C.text }}>
              {item.name}
            </span>
          </Link>
          <span
    ...
    >
      ...
      <div>
        ...
        >
          ...
          <span style={{ fontFamily: SANS, fontSize: 11, color: C.textSoft }}>
            {item.handle}
          </span>
          <span
            style={{
    ...
    >
      <button
        ...
        style={{
          ...
          justifyContent: "center",
          background: "transparent",
          border: `1px solid ${current === 1 ? C.textMuted : C.border}`,
          color: current === 1 ? C.textMuted : C.textSoft,
        ...
        acc.push(
          <button
            ...
            style={{
              ...
              alignItems: "center",
              justifyContent: "center",
              background: p === current ? C.accentGlow : "transparent",
              border: `1px solid ${p === current ? C.accentDim : C.border}`,
              color: p === current ? C.accent : C.textSoft,
              cursor: "pointer",
              fontFamily: SERIF,
              fontSize: 18,
            }}
      ...
      <button
        ...
        style={{
          ...
          justifyContent: "center",
          background: "transparent",
          border: `1px solid ${current === total ? C.textMuted : C.border}`,
          color: current === total ? C.textMuted : C.textSoft,
...
export function Search() {
  ...
  const [enrichedFilms, setEnrichedFilms] = useState<
    Record<number, FilmDetails>
  >({});
  const [loadingFilmDetails, setLoadingFilmDetails] = useState<
    ...
    >
      ...
      <div style={{ paddingTop: "var(--nav-height, 72px)" }}>
        ...
        >
          ...
          >
            <button
              className="search-results-desktop-only"
              ...
              style={{
                ...
                padding: "8px 16px",
                background: "transparent",
                color: showFilters ? C.accent : C.textSoft,
                border: `1px solid ${showFilters ? C.accentDim : C.border}`,
                cursor: "pointer",
                fontFamily: SANS,
                fontSize: 10,
                letterSpacing: "0.16em",
          ...
          {TABS.map((tab) => (
            <button
              ...
              style={{
                ...
                letterSpacing: "0.16em",
                textTransform: "uppercase",
                color: activeTab === tab.key ? C.text : C.textSoft,
                cursor: "pointer",
                marginBottom: -1,
                display: "flex",
                alignItems: "center",
        ...
        >
          <AnimatePresence key="drawer-presence">
            <div
              key="filters-drawer"
              className={`search-filters-drawer ${isFiltersOpen ? "search-filters-drawer--open" : ""}`}
            >
          ...
          <div style={{ flex: 1, padding: "32px 48px", minWidth: 0 }}>
            <button
              className="search-results-mobile-only-btn"
                      ...
                      if ("mediaType" in mergedFilm) {
                        return (
                          <FilmResultItem
                            ...
                            initialWatchlisted={myWatchlist.includes(
                              mergedFilm.id,
                            )}
                          />
                        );
