...
import {
  ...
  SERIF,
  textClampOneLine,
} from "../components/profile-v2/theme";
...
function CinematicSignature({
  ...
  return (
    ...
    >
      ...
      <div
        className="profile-signature-bar"
        style={{
          maxWidth: 1280,
          margin: "0 auto",
          display: "flex",
      ...
      >
        <div
          className="profile-signature-label-col"
          style={{
            flexShrink: 0,
        ...
        <div
          className="profile-signature-fields"
          style={{
            flex: 1,
            display: "flex",
            alignItems: "stretch",
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                cursor: "default",
                background:
                  hoveredField === i ? "rgba(212,175,122,0.04)" : "transparent",
              }}
            >
              <div
                style={{
              ...
              {isEditing ? (
                <>
                  <textarea
                    value={
                      (draft[field.key as keyof CinematicSignaturePayload] as
                        | string
                        | null) || ""
                    }
                    onChange={(event) => {
                  ...
                  <textarea
                    value={
                      (draft[
                        field.detailKey as keyof CinematicSignaturePayload
                      ] as string | null) || ""
                    }
                    onChange={(event) => {
                      const nextValue = event.target.value.slice(0, 280);
  ...
  return (
    <div
      style={{
        ...
        background:
          "linear-gradient(90deg, rgba(212,175,122,0.14), rgba(212,175,122,0.02))",
      }}
    >
      <div
      ...
      >
        ...
        >
          ...
          <strong style={{ fontWeight: 600 }}>{score}%</strong>
        </div>
        <div
          style={{
            color: C.textSoft,
...
export function Profile() {
  ...
  const isValidTab = (
    value: string | null,
  ): value is (typeof PROFILE_TABS)[number] =>
    Boolean(value) &&
    PROFILE_TABS.includes(value as (typeof PROFILE_TABS)[number]);
  ...
  const [localSignature, setLocalSignature] =
    useState<CinematicSignaturePayload | null>(signature);
  const [localCuratedItems, setLocalCuratedItems] = useState<
    ...
    >
      ...
      <div className="profile-hero-container">
        <ProfileHero
          ...
          onNavigateToUser={(targetUsername: string) =>
      ...
      {isPublicProfile && (
        <CompatibilityBanner
          reviewsCount={displayStats.reviews}
          followersCount={displayStats.followers}
        />
      )}
      ...
      <TabsBar
        active={activeTab}
        onSelect={(tab: string) => handleTabChange(normalizeTab(tab))}
      />
      ...
      >
        ...
        >
          <div style={{ flexShrink: 0 }}>
            ...
            >
              Seleccionados:{" "}
              <strong style={{ color: C.accent }}>{selected.length} / 6</strong>
            </p>
          </div>
