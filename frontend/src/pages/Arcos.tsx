...
function StackedPosters({ posters }: { posters: string[] }) {
  return (
    <div
      style={{ position: "relative", width: 80, height: 114, flexShrink: 0 }}
    >
        ...
        >
          ...
          <div style={{ display: "flex", gap: 20, alignItems: "center" }}>
            ...
            >
              ...
              {arco.usersCompleted.toLocaleString("es")}
            </span>
          </div>
    ...
    >
      ...
      <div style={{ padding: "64px 48px 0", maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          >
            Cada arco es una secuencia pensada. El orden importa. El contexto
            importa.
          </div>
        </motion.div>
      </div>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 48px 80px" }}>
        {loading && (
          <div style={{ color: C.textSoft, marginBottom: 12 }}>
            Cargando arcos...
          </div>
        )}
        {error && (
          <div style={{ color: "#C97B7B", marginBottom: 12 }}>{error}</div>
        )}
