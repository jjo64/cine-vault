  ...
  return (
    ...
    >
      <div
        style={{
          display: "grid",
          gridTemplateColumns: "52px 64px 1fr auto",
          gap: 20,
      ...
      >
        ...
        <div style={{ paddingTop: 2 }}>
          ...
          >
            ...
            <span style={{ fontSize: 11, color: C.accent, fontFamily: SANS }}>
          ...
          >
            {film.voterCount.toLocaleString("es")} votos
          </div>
        </div>
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      try {
        ...
        setCompletedRanking([]);
        setError(
          "No se pudo cargar el ranking de Mentiras. Intenta nuevamente en unos minutos.",
        );
      } finally {
        if (active) {
          setLoading(false);
    ...
    >
      ...
      <div style={{ padding: "64px 80px 0", maxWidth: 1080, margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            <em style={{ fontStyle: "italic", color: C.textSoft }}>
              Supuestamente.
            </em>
          </div>
          <div
          ...
          >
            El porcentaje muestra cuántos usuarios de CineVault admitieron no
            haber terminado cada película. La confesión más votada está debajo
            de la barra.
          </div>
        </motion.div>
      </div>
      ...
      >
        ...
        <div>
          ...
          {error && (
            <div style={{ color: "#C97B7B", marginBottom: 16 }}>{error}</div>
          )}
          <div
            style={{
              fontSize: 10,
          ...
          <div style={{ marginTop: 56 }}>
            ...
            >
              <span
                style={{ fontFamily: SERIF, fontSize: 26, fontWeight: 400 }}
              >
                Las que la gente sí terminó
              </span>
              <em
                style={{
                  fontFamily: SERIF,
              ...
              >
                aunque nadie lo admite
              </em>
              {showSurprising ? (
                <ChevronUp size={16} color={C.accentDim} />
              ) : (
                <ChevronDown size={16} color={C.accentDim} />
              )}
            </button>
        ...
        <div style={{ position: "sticky", top: 80 }}>
          ...
          >
            ...
            {[
              {
                label: "Películas evaluadas",
                value: ranking.length.toString(),
              },
              {
                label: "Votos totales",
                value: ranking
                  .reduce((a, f) => a + f.voterCount, 0)
                  .toLocaleString("es"),
              },
              {
                label: "Peor vergüenza",
                value: ranking.length
                  ? `${Math.max(...ranking.map((f) => f.shamePct))}%`
                  : "—",
              },
              {
                label: "Honestidad promedio",
                value: ranking.length
                  ? `${Math.round(ranking.reduce((a, f) => a + f.shamePct, 0) / ranking.length)}%`
                  : "—",
              },
            ].map((stat) => (
              <div
              ...
              >
                ...
                <span
                  style={{ fontFamily: SERIF, fontSize: 18, color: C.text }}
                >
                  {stat.value}
                </span>
              </div>
          ...
          >
            "El acto de no terminar una película también dice algo sobre vos
            como espectador."
          </div>
        </div>
      </div>
