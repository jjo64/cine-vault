...
export default function ReviewsSection({
  ...
  const buildReviewThreadHref = (review: AppReview) => {
    ...
    const preferredId =
      tvTmdbId != null && Number.isFinite(tvTmdbId)
        ? tvTmdbId
        : review.tmdb_id != null && Number.isFinite(review.tmdb_id)
          ? review.tmdb_id
          : null;
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  >
                    <span
                      style={{ fontFamily: SANS, fontSize: 13, color: C.text }}
                    >
                      @{review.username}
                    </span>
