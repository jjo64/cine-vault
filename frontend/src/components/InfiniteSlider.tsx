...
const InfiniteSlider: React.FC = () => {
  ...
  return (
    <section
      className="infinite-slider-section"
      style={{
        overflow: "hidden",
        padding: "20px 0",
...
function horizontalLoop(
  ...
  gsap.set(elements, {
    // convert "x" to "xPercent" to make things responsive, and populate arrays for faster lookup.
    xPercent: (i, el) => {
  ...
  const totalWidth =
    ...
    elements[length - 1].offsetWidth *
      parseFloat(gsap.getProperty(elements[length - 1], "scaleX") as string) +
