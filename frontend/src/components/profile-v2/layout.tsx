  ...
  return (
    <nav
      ...
      style={{
        ...
        background:
          "linear-gradient(to bottom, rgba(8,8,8,0.98) 0%, transparent 100%)",
        fontFamily: SANS,
      }}
    >
      <button onClick={onNavigateHome} className="profile-nav-logo">
        Cine<span style={{ color: C.accent }}>Vault</span>
      </button>

      <ul
        className="profile-nav-links"
        style={{ gap: 36, listStyle: "none", margin: 0, padding: 0 }}
      >
        {[
          "Diario",
          "Esta noche",
      ...
      <div
        className="profile-nav-actions"
        style={{ display: "flex", alignItems: "center" }}
      >
        <div
          ref={wrapperRef}
          className="profile-nav-search-wrapper"
        ...
        >
          ...
          >
            ...
            <button
              type="submit"
              aria-label="Buscar"
              style={{ ...inputButtonReset, color: C.textSoft, padding: 2 }}
            >
              <Search size={17} />
            </button>
          </form>
        ...
        <div className="profile-mobile-only" style={{ position: "relative" }}>
          ...
          {isMobileMenuOpen && (
            ...
            >
              {["Explorar", "Feed", "Esta noche", "Diario", "Perfil"].map(
                (label) => (
                  <button
                    key={label}
                    onClick={() => {
      ...
      >
        ...
        <div className="profile-hero-stats-wrapper">
          {[
            ...
            >
              <span
                className="profile-hero-stat-num"
                style={{
                  fontFamily: SERIF,
                  fontWeight: 300,
                  display: "block",
          ...
          >
            <motion.div
              ...
              style={{
                ...
                border: `1px solid ${C.border}`,
                background:
                  "linear-gradient(160deg, rgba(15,18,25,0.98) 0%, rgba(9,11,16,0.98) 100%)",
                boxShadow:
                  "0 28px 80px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.03)",
              }}
            >
              <div
                style={{
              ...
              <div
                style={{
                  maxHeight: "calc(min(78vh, 620px) - 56px)",
                  overflowY: "auto",
