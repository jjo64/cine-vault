...
function getSeoConfig(pathname: string, search: string): RouteSeoConfig {
  ...
  if (pathname === "/") {
    return {
      ...
      description:
        "Guardá películas en tu vault, escribí reseñas, llevá tu diario de cine y recibí una recomendación irrechazable cada noche.",
      canonical: `${BASE_URL}/`,
    };
  }
  ...
  if (pathname === "/feed" || pathname === "/discover") {
    return {
      ...
      description:
        "Explorá películas populares, últimos estrenos, las más valoradas y descubrí tu próxima obsesión cinematográfica.",
  ...
  if (pathname.startsWith("/tv/")) {
    return {
      ...
      description:
        "Consulta reparto, temporadas, plataformas y valoraciones de esta serie en CineVault.",
      canonical: `${BASE_URL}${pathname}`,
    };
  }
  ...
  if (pathname.startsWith("/person/")) {
    return {
      ...
      description:
        "Descubrí la biografía y filmografía completa de este actor, director o miembro del equipo técnico.",
      canonical: `${BASE_URL}${pathname}`,
    };
  }
  ...
  if (
    ...
    return {
      title: query
        ? `Resultados para "${query}" — CineVault`
        : "Buscar películas — CineVault",
      description:
        "Buscá películas, series, directores y actores en la base de datos de CineVault.",
  ...
  if (pathname.startsWith("/vault/")) {
    ...
    return {
      title: username
        ? `Vault de ${username} — CineVault`
        : "Vault creativo — CineVault",
      description:
        "Explora el vault creativo con reseñas, mood boards, audio-notas, listas y piezas audiovisuales de la comunidad CineVault.",
      canonical: `${BASE_URL}${pathname}`,
    };
  }
  ...
  if (pathname === "/arcos") {
    return {
      ...
      description:
        "Rutas de formación cinematográfica por autores, movimientos y estilos. No son listas: son trayectos editoriales.",
  ...
  if (pathname.startsWith("/arcos/")) {
    return {
      ...
      description:
        "Secuencia editorial de películas con progreso, contexto y orden recomendado para aprender cine en serio.",
      canonical: `${BASE_URL}${pathname}`,
    };
  }
  ...
  if (pathname === "/diary") {
    return {
      ...
      description:
        "Tu autobiografía en películas: sesiones simples, dobles funciones, sesiones triples y maratones.",
  ...
  if (pathname.startsWith("/director/") && pathname.endsWith("/autopsy")) {
    return {
      ...
      description:
        "Disección editorial de una filmografía: timeline, contexto histórico y métricas de comunidad en CineVault.",
      canonical: `${BASE_URL}${pathname}`,
    };
  }
  ...
  if (pathname === "/mentiras") {
    return {
      ...
      description:
        "Ranking comunitario de películas que todos dicen haber terminado. Vota con honestidad: nadie te está mirando.",
  ...
  if (pathname === "/lists") {
    return {
      ...
      description:
        "Creá, organizá y compartí listas de películas con tu propio criterio cinéfilo.",
  ...
  if (pathname.startsWith("/news")) {
    return {
      ...
      description:
        "Leé las últimas novedades, estrenos y tendencias del universo cinematográfico.",
      canonical: `${BASE_URL}${pathname}`,
    };
  }
  ...
  return {
    ...
    description:
      "La plataforma cinematográfica para cinéfilos. Guardá películas, escribí reseñas y descubrí cine.",
    canonical: `${BASE_URL}${pathname}`,
  };
}
