    ...
    <div style={{ display: "flex", gap: 2 }}>
      {Array.from({ length: 5 }).map((_, i) => (
        <svg
          ...
          height={size}
          viewBox="0 0 12 12"
          fill={i < rating ? C.gold : C.textMuted}
        >
...
function FilmCardMini({
  ...
  return (
    ...
    >
      <Link
        to={`/movie/${movieId}-${createSlug(title)}`}
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to top, rgba(8,8,8,0.92) 0%, transparent 55%)",
              opacity: hovered ? 1 : 0,
...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      <ul
        className="landing-desktop-links landing-nav-links"
        style={{
          display: "flex",
          listStyle: "none",
          margin: 0,
                ...
                onClick={() => {
                  window.dispatchEvent(
                    new CustomEvent("open-auth-modal", {
                      detail: {
                        mode: link === "Create account" ? "register" : "login",
                      },
                    }),
                  );
                }}
      ...
      <div className="landing-nav-right">
        <div
          ref={containerRef}
          className={`landing-search ${menuOpen ? "landing-search-compressed" : ""}`}
              ...
              {visibleResults.length > 0 ? (
                visibleResults.map((movie) => (
                  ...
                  >
                    <Img
                      src={
                        movie.media_type === "person"
                          ? movie.profile_path
                            ? `https://image.tmdb.org/t/p/w92${movie.profile_path}`
                            : "/no-poster.svg"
                          : movie.poster_path
                    ...
                    />
                    <span
                      className="landing-search-title"
                      style={{
                        fontFamily: SANS,
                        fontSize: 13,
                        letterSpacing: "0.04em",
                    ...
                    if (link === "Sign in" || link === "Create account") {
                      window.dispatchEvent(
                        new CustomEvent("open-auth-modal", {
                          detail: {
                            mode:
                              link === "Create account" ? "register" : "login",
                          },
                        }),
                      );
                    } else {
    ...
    >
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: `linear-gradient(to bottom, rgba(8,8,8,0.2) 0%, transparent 30%, rgba(8,8,8,0.5) 70%, ${C.bg} 100%)`,
          zIndex: 1,
        }}
      />
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: `radial-gradient(ellipse at 30% 60%, ${C.accentGlow} 0%, transparent 60%)`,
          zIndex: 1,
        }}
      />
      ...
      >
        ...
        >
          El lugar donde el cine deja de ser entretenimiento y se convierte en
          formacion.
        </motion.p>
        ...
        >
          ...
          <motion.div
            ...
            style={{
              width: 1,
              height: 32,
              background: `linear-gradient(to bottom, ${C.accentDim}, transparent)`,
            }}
          />
        </motion.div>
      </div>
        ...
        {movies.map((movie, i) => (
          ...
          >
            <FilmCardMini
              ...
              rating={Math.max(
                1,
                Math.min(5, Math.round((movie.vote_average || 0) / 2)),
              )}
              img={
                movie.poster_path
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Para personas que quieren hacer del cine su vida, no para personas que
          quieren ver peliculas.
        </p>
      </motion.div>
    ...
    >
      <div className="landing-grid-night">
        ...
        >
          ...
          >
            Cada noche a las 20h, CineVault te da una pelicula. Una sola.
            Irrechazable. Si la ves, sumas puntos, desbloqueas logros y avanzas.
          </p>
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              >
                ...
                >
                  <Star size={10} fill={C.gold} color={C.gold} /> +40 pts esta
                  noche
                </div>
              </div>
            </div>
        ...
        >
          <div
            style={{ aspectRatio: "4/5", overflow: "hidden", borderRadius: 2 }}
          >
            <Img
              src={IMG.street}
              alt="Cine de noche"
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background: C.accent,
              boxShadow: `0 0 20px ${C.accentGlowStrong}`,
            }}
          />
        </motion.div>
      </div>
        ...
        {publicReviews.map((review, i) => (
          ...
          >
            ...
            >
              ...
              <div>
                <div style={{ fontFamily: SANS, fontSize: 11, color: C.text }}>
                  {review.user}
                </div>
                <div
                  style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Empeza con una pelicula. La que mas te marco. La que cambio como ves
          el mundo.
        </p>
        ...
        >
          {[
            {
              icon: <Lock size={12} />,
              text: "Sin algoritmos que te manipulen",
            },
            {
              icon: <Users size={12} />,
              text: "Comunidad de cinefilos reales",
            },
...
function Footer() {
  const cols = [
    {
      title: "Explorar",
      links: ["Films", "Directores", "Listas", "Journal", "Miembros"],
    },
    {
      title: "Tu cuenta",
      links: [
    ...
    {
      title: "CineVault",
      links: ["Quienes somos", "Manifiesto", "Prensa", "Contacto", "API"],
    },
  ];
    ...
    >
      <div className="landing-footer-grid">
        <div>
          ...
          >
            Para personas que quieren hacer del cine su vida, no para personas
            que quieren ver peliculas.
          </p>
          <div
            style={{
              fontFamily: SANS,
    ...
    >
      ...
      <main id="main-content">
        ...
        <section className="landing-section-sm" style={{ background: C.bg }}>
          <SectionHeader
            eyebrow="Lo que otros usuarios estan viendo"
            title="El canon esta vivo"
          />
          <InfiniteSlider />
        </section>
        <MovieGridSection
