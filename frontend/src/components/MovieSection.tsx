...
const MovieSection: React.FC<MovieSectionProps> = ({ title, endpoint }) => {
    ...
    return (
        <section className="movie-section" style={{ padding: '40px 20px', maxWidth: '1200px', margin: '0 auto' }}>
                    ...
                    >
                        <div style={{ position: 'relative', borderRadius: '4px', overflow: 'hidden' }}>
                            ...
                            <div className="hover-overlay" style={{
                                ...
                                <span style={{ color: '#00e054', fontWeight: 'bold', fontSize: '14px' }}>★ {movie.vote_average.toFixed(1)}</span>
                            </div>
                        </div>
                        <style>{`
