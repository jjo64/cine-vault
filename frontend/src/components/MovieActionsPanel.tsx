    ...
    <div className="movie-actions-panel">
      ...
      <div className="action-icons">
        ...
        >
          <svg
            viewBox="0 0 24 24"
            fill={watched ? "#00e054" : "none"}
            stroke={watched ? "#00e054" : "#9ab"}
          >
            <path
              strokeLinecap="round"
        ...
        >
          <svg
            viewBox="0 0 24 24"
            fill={liked ? "#ff8000" : "none"}
            stroke={liked ? "#ff8000" : "#9ab"}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          <svg
            viewBox="0 0 24 24"
            fill={watchlist ? "#00b020" : "none"}
            stroke={watchlist ? "#00b020" : "#9ab"}
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      <ul className="action-menu">
        <li>
          <button type="button">Show your activity</button>
        </li>
        <li>
      ...
      <button
        type="button"
        className="share-btn"
        aria-label="Compartir esta película"
      >
        Compartir
      </button>
    </div>
