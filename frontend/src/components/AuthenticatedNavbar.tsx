  ...
  return (
    <nav className="auth-nav">
      ...
      <div className="auth-nav-actions">
        <div className="auth-nav-search-wrapper" ref={searchRef}>
          ...
          {isSearchOpen && (debouncedQuery || isSearching) && (
            <div className="auth-nav-suggestions">
              {isSearching && (
                <div style={{ padding: 12, fontSize: 11, color: "#7A7A7A" }}>
                  BUSCANDO...
                </div>
              )}
              {!isSearching &&
                searchResults.map((item) => (
                  <button
                    ...
                    className="auth-nav-suggestion-item"
        ...
        {user && (
          <div
            className="auth-nav-notifications-wrapper"
          ...
          <div className="auth-nav-profile" ref={userMenuRef}>
            ...
            >
              {user?.avatar_url ? (
                <img
                  src={user.avatar_url}
                  alt={user.username}
                  className="auth-nav-avatar-img"
                />
              ) : (
                <span className="auth-nav-avatar-initials">
            ...
            {showUserMenu && (
              <div className="auth-nav-dropdown">
                ...
                <div
                  style={{ height: 1, background: "#252525", margin: "4px 0" }}
                />
                <button
                  className="auth-nav-dropdown-item auth-nav-dropdown-danger"
