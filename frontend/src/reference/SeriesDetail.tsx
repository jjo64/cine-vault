...
const SERIES = {
  ...
  quote:
    "La televisión es el formato perfecto para el sueño. Podés entrar en él una hora a la semana durante años.",
  quoteAuthor: "David Lynch — entrevista con Chris Rodley, 1997",
  cinevaultCase:
    "Twin Peaks no es una serie. Es un acto de resistencia. David Lynch tomó el formato televisivo de los 90 y lo usó como materia prima para algo que el cine de autor no podía hacer solo: una experiencia de 48 horas de duración dentro de un inconsciente americano. Está aquí porque lo merece.",
  themes: [
    "Neo-noir",
    "El mal americano",
    "Surrealismo",
  ...
  awards: [
    {
      icon: "🏆",
      name: "Premio Peabody",
      fest: "George Foster Peabody Awards, 1991",
    },
    {
      icon: "🎖️",
      name: "3 Emmy · Mejor Dirección, Mejor Actriz",
      fest: "43rd Primetime Emmy Awards, 1991",
    },
    {
      icon: "🎞️",
      name: "Top 10 series del siglo · Metacritic",
      fest: "The Return (2017)",
    },
    {
      icon: "⭐",
      name: "Premio del Jurado · Cannes 2017",
      fest: "The Return, Festival de Cannes",
    },
  ],
  cast: [
    {
      name: "Kyle MacLachlan",
      role: "Agent Dale Cooper / Mr. C",
      initial: "K",
    },
...
const SEASONS: Season[] = [
  {
    ...
    network: "ABC",
    synopsis:
      "El piloto establece Twin Peaks como un lugar que existe entre lo real y lo onírico. Cooper llega, toma café, y el caso de Laura Palmer empieza a revelar que el pueblo tiene secretos que van más allá de cualquier crimen convencional.",
    poster:
      "https://images.unsplash.com/photo-1603882924554-4def74ff2aec?w=400&q=80",
    episodes: [
      {
        id: 101,
        season: 1,
        ...
        isKey: true,
        keyNote:
          "Uno de los pilotos más importantes de la historia. Lynch lo filmó como una película. Dale Cooper entra al pueblo y el mundo ya no es el mismo.",
      ...
      },
      {
        ...
        isKey: true,
        keyNote:
          "El sueño del Cuarto Rojo aparece por primera vez. Es una de las escenas más influyentes de la televisión.",
        director: "David Lynch",
        avgRating: 4.7,
      },
      {
  ...
  },
  {
    ...
    network: "ABC",
    synopsis:
      "La segunda temporada revela quién mató a Laura Palmer en sus primeros episodios — y luego paga el costo. Sin el misterio central, la serie se desintegra y se vuelve a encontrar. Los últimos episodios, dirigidos por Lynch, son posiblemente lo mejor de toda la serie.",
    poster:
      "https://images.unsplash.com/photo-1717912973650-59604d5659bd?w=400&q=80",
    episodes: [
      {
        id: 201,
        season: 2,
        ...
        isKey: true,
        keyNote:
          "Lynch vuelve a dirigir. El Gigante aparece. El tono cambia de forma radical y definitiva.",
        director: "David Lynch",
        avgRating: 4.6,
      },
      {
      ...
      },
      {
        ...
        isKey: true,
        keyNote:
          "El episodio más importante de la serie. Lynch lo dirigió personalmente. Revela quién mató a Laura Palmer. Hay que verlo sin saber nada.",
        director: "David Lynch",
        avgRating: 4.9,
      },
      {
      ...
      },
      {
        ...
        isKey: true,
        keyNote:
          "El final más enigmático de la historia de la TV. No resuelve nada. Fue diseñado así. Cooper entra al Cuarto Rojo y la serie termina como si el reloj se detuviera.",
        director: "David Lynch",
        avgRating: 4.8,
      },
    ],
  },
  {
    ...
    network: "Showtime",
    synopsis:
      "Veinticinco años después. Lynch y Frost retoman la serie con total libertad creativa en Showtime. El resultado es 18 horas de cine puro — Lynch escribió, dirigió y editó cada parte. No es televisión. Es la película más larga de su carrera.",
    poster:
      "https://images.unsplash.com/photo-1706418904655-fce62a6476f6?w=400&q=80",
    episodes: [
      {
        id: 301,
        season: 3,
        ...
        isKey: true,
        keyNote:
          "Veinticinco años después. Cooper sigue en el Cuarto Rojo. Lynch establece que esto no es una continuación — es otra cosa completamente.",
        director: "David Lynch",
        avgRating: 4.5,
      },
      {
      ...
      },
      {
        ...
        isKey: true,
        keyNote:
          "El episodio más radical de la historia de la televisión. Lynch deja de contar una historia y muestra el origen del mal. Experimental puro. Hay consenso universal sobre su importancia.",
        director: "David Lynch",
        avgRating: 4.98,
      },
      {
        ...
        isKey: true,
        keyNote:
          "Cooper intenta rescribir la historia. La serie alcanza su punto álgido antes del final.",
        director: "David Lynch",
        avgRating: 4.7,
      },
      {
        ...
        isKey: true,
        keyNote:
          "El final más perturbador que Lynch filmó. No cierra nada. Lo abre todo. La última imagen es un loop al vacío.",
        director: "David Lynch",
        avgRating: 4.6,
      },
    ],
...
const STILLS = [
  {
    label: "Los bosques de Twin Peaks",
    img: "https://images.unsplash.com/photo-1603882924554-4def74ff2aec?w=900&q=80",
  },
  {
    label: "El Cuarto Rojo",
    img: "https://images.unsplash.com/photo-1702326506930-fb2fdb824908?w=600&q=80",
  },
  {
    label: "La cabaña negra",
    img: "https://images.unsplash.com/photo-1768661608008-74f74ad6923a?w=600&q=80",
  },
  {
    label: "Cooper en la niebla",
    img: "https://images.unsplash.com/photo-1737525589029-b26d4886ed3b?w=600&q=80",
  },
  {
    label: "Double R Diner",
    img: "https://images.unsplash.com/photo-1706418904655-fce62a6476f6?w=600&q=80",
  },
];
...
const SIMILAR = [
  {
    title: "The Leftovers",
    year: "2014–2017",
    img: "https://images.unsplash.com/photo-1691573252567-6c1be35aae79?w=400&q=80",
  },
  {
    title: "True Detective T1",
    year: "2014",
    img: "https://images.unsplash.com/photo-1563941433-b6a094653ed2?w=400&q=80",
  },
  {
    title: "The Americans",
    year: "2013–2018",
    img: "https://images.unsplash.com/photo-1698159929266-28e8e8ef6b33?w=400&q=80",
  },
  {
    title: "Rectify",
    year: "2013–2016",
    img: "https://images.unsplash.com/photo-1670782128814-c5a55b68f50d?w=400&q=80",
  },
  {
    title: "Carnivàle",
    year: "2003–2005",
    img: "https://images.unsplash.com/photo-1762541693135-fb989de961e1?w=400&q=80",
  },
  {
    title: "Six Feet Under",
    year: "2001–2005",
    img: "https://images.unsplash.com/photo-1769121803735-59cde1085231?w=400&q=80",
  },
];
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(to right, rgba(8,8,8,0.98) 42%, rgba(8,8,8,0.6) 70%, transparent 100%)",
        }}
      />
      <div
        style={{
          position: "absolute",
          inset: 0,
          background: `linear-gradient(to bottom, transparent 20%, rgba(8,8,8,0.55) 60%, ${C.bg} 100%)`,
        }}
      />
      ...
      <div
        style={{
          ...
          width: 600,
          height: 500,
          background: `radial-gradient(ellipse at bottom left, ${C.accentGlow}, transparent 65%)`,
          pointerEvents: "none",
        }}
      />
      ...
      >
        <div
          style={{
            ...
            overflow: "hidden",
            boxShadow:
              "0 40px 100px rgba(0,0,0,0.9), 0 0 0 1px rgba(255,255,255,0.04)",
            position: "relative",
          }}
        >
          <Img
            src="https://images.unsplash.com/photo-1717912973650-59604d5659bd?w=600&q=80"
            alt="Twin Peaks poster"
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(135deg, rgba(255,255,255,0.04) 0%, transparent 50%, rgba(0,0,0,0.3) 100%)",
            }}
          />
          <div
            style={{
      ...
      >
        ...
        >
          ...
          >
            <Tv size={10} color={C.textMuted} /> {SERIES.totalSeasons}{" "}
            temporadas · {SERIES.totalEpisodes} ep.
          </span>
        </div>
        ...
        >
          ...
          >
            ...
            <span
              style={{ fontSize: 14, color: C.textMuted, fontFamily: SANS }}
            >
              /5
            </span>
            <span
          ...
          <div style={{ fontSize: 11, color: C.textMuted, fontFamily: SANS }}>
        ...
        {tracking && (
          ...
          >
            <div>
              ...
              <div style={{ fontSize: 13, color: C.text, fontFamily: SANS }}>
                T2 · <span style={{ color: C.accent }}>Ep. 7</span> de 22
              </div>
            </div>
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.borderColor = C.textSoft;
          ...
          {[
            {
              icon: (
                <Bookmark
                  size={15}
                  strokeWidth={1.5}
                  fill={inWatchlist ? C.accent : "none"}
                />
              ),
              active: inWatchlist,
              action: () => setInWatchlist((v) => !v),
              title: "Watchlist",
            },
            {
              icon: (
            ...
            <button
              ...
              style={{
                ...
                justifyContent: "center",
                background: "transparent",
                color: btn.active ? C.accent : C.textSoft,
                border: `1px solid ${btn.active ? C.accentDim : C.border}`,
                cursor: "pointer",
                transition: "all 0.2s",
              }}
              onMouseEnter={(e) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ¿Por qué está esto en CineVault?
        </div>
        <div
          style={{
            fontFamily: SERIF,
        ...
        <div style={{ display: "flex", gap: 0 }}>
          {SEASONS.map((s, i) => {
            ...
            const seasonWatched = s.episodes.filter((e) =>
              watchedIds.has(`s${s.number}e${e.number}`),
            ).length;
            return (
              <div
                key={s.id}
      ...
      >
        ...
        <div>
          ...
          >
            ...
            {ep.director && (
              <span
                style={{ fontSize: 11, color: C.accentDim, fontFamily: SANS }}
              >
                Dir. {ep.director}
              </span>
            )}
            ...
            <div style={{ display: "flex", gap: 2 }}>
              {Array.from({ length: 5 }).map((_, i) => (
                <svg
                  ...
                  height="9"
                  viewBox="0 0 12 12"
                  fill={i < Math.round(ep.avgRating) ? C.gold : C.textMuted}
                  opacity={0.7}
                >
              ...
              <div style={{ display: "flex", gap: 2 }}>
                {Array.from({ length: 5 }).map((_, i) => (
                  <svg
                    ...
                    height="9"
                    viewBox="0 0 12 12"
                    fill={i < userRating ? C.accent : C.textMuted}
                  >
                    <path d="M6 1l1.3 2.6L10 4l-2 2 .5 2.8L6 7.5 3.5 8.8 4 6 2 4l2.7-.4z" />
                  </svg>
                ))}
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              justifyContent: "center",
              background: "none",
              border: `1px solid ${ratingOpen ? C.accentDim : C.border}`,
              color: ratingOpen ? C.accent : C.textSoft,
              cursor: "pointer",
              transition: "all 0.2s",
              fontSize: 14,
              opacity: hov || ratingOpen ? 1 : 0,
            }}
          >
            ★
          </button>
...
function SeasonsPanel({
  ...
  setEpisodeRatings: React.Dispatch<
  ...
  const seasonWatched = season.episodes.filter((e) =>
    watchedIds.has(`s${e.season}e${e.number}`),
  ).length;
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                <span
                  style={{ fontFamily: SERIF, fontSize: 22, color: C.text }}
                >
                ...
                <span
                  style={{ fontSize: 10, color: C.textSoft, fontFamily: SANS }}
                >
                  {season.year}
                </span>
                <span
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <span
                  style={{ fontSize: 10, color: C.textSoft, fontFamily: SANS }}
                >
                  {seasonWatched}/{season.totalEpisodes} vistos
                </span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            {hasMore && (
              ...
              >
                Ver los {season.totalEpisodes - season.episodes.length}{" "}
                episodios restantes
                <ChevronDown size={12} />
              </button>
            )}
            {season.totalEpisodes > season.episodes.length && (
              ...
              >
                * Se muestran {season.episodes.length} de {season.totalEpisodes}{" "}
                episodios. La base de datos incluye el listado completo.
              </div>
            )}
          </div>
        </motion.div>
          ...
          return (
            <button
              ...
              style={{
                ...
                letterSpacing: "0.12em",
                textTransform: "uppercase",
                color: lit ? C.accent : C.textSoft,
                border: `1px solid ${lit ? C.accentDim : C.border}`,
                background: lit ? C.accentGlow : "transparent",
                padding: "6px 14px",
                cursor: "pointer",
                transition: "all 0.2s",
                fontFamily: SANS,
        ...
        {STILLS.map((still, i) => {
          ...
          return (
            <div
              key={i}
              style={{
                gridRow: isMain ? "span 2" : undefined,
                position: "relative",
                overflow: "hidden",
                aspectRatio: isMain ? undefined : "4/3",
                cursor: "pointer",
                ...(isMain ? { minHeight: 300 } : {}),
              }}
      ...
      >
        {SERIES.cast.map((member) => (
          ...
          >
            ...
            >
              <span
                style={{ fontFamily: SERIF, fontSize: 16, color: C.accentDim }}
              >
                {member.initial}
              </span>
            </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
        {REVIEWS.map((review, i) => (
          ...
          >
            ...
            >
              <span
                style={{ fontFamily: SERIF, fontSize: 18, color: C.accentDim }}
              >
                {review.initial}
              </span>
            </div>
                ...
                <div style={{ display: "flex", gap: 2 }}>
                  {Array.from({ length: 5 }).map((_, i) => (
                    <svg
                      ...
                      height="10"
                      viewBox="0 0 12 12"
                      fill={i < review.rating ? C.gold : C.textMuted}
                    >
                      <path d="M6 1l1.3 2.6L10 4l-2 2 .5 2.8L6 7.5 3.5 8.8 4 6 2 4l2.7-.4z" />
                    </svg>
                  ))}
...
export function SeriesDetail() {
  ...
  const [watchedIds, setWatchedIds] = useState<Set<string>>(
    new Set(["s1e1", "s1e2", "s1e3", "s2e1", "s2e2"]),
  );
        ...
        <aside>
          ...
          >
            ...
            >
              ...
              >
                {SERIES.totalRatings} valoraciones
              </div>
              {/* Mini distribution */}
              <div
                style={{
                ...
                {[4, 8, 14, 28, 46].map((h, i) => (
                  <div
                    ...
                    style={{
                      flex: 1,
                      height: `${h}px`,
                      background: i === 4 ? C.accent : C.elevated,
                      borderRadius: 1,
                    }}
                  />
                ))}
