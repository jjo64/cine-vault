...
const DiaryPage = lazy(() =>
  import("./pages/Diary").then((module) => ({ default: module.Diary })),
);
const DirectorAutopsyPage = lazy(() =>
  import("./pages/DirectorAutopsy").then((module) => ({
    default: module.DirectorAutopsy,
  })),
);
const MentirasPage = lazy(() =>
  import("./pages/Mentiras").then((module) => ({ default: module.Mentiras })),
);
...
function App() {
  ...
  useEffect(() => {
    const handler = (event: Event) => {
      ...
      setAuthMode(
        customEvent.detail?.mode === "register" ? "register" : "login",
      );
    ...
    <SocketProvider>
      ...
      >
        ...
        <Routes>
          ...
          <Route
            path="/director/:id/autopsy"
            element={<DirectorAutopsyPage />}
          />
          ...
          <Route
            path="/:username/movie/:slugId"
            element={<ReviewThreadPage />}
          />
          <Route
            path="/:username/movie/:slugId/:index"
            element={<ReviewThreadPage />}
          />
          <Route path="/:username/tv/:slugId" element={<ReviewThreadPage />} />
          <Route
            path="/:username/tv/:slugId/:index"
            element={<ReviewThreadPage />}
          />
