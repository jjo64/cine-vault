    ...
    <div onClick={onClose} className="md-list-overlay">
      ...
      >
        <div className="md-modal-header">
          <div className="md-modal-header-title">Anadir a lista</div>
        ...
        <div style={{ padding: 16 }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <div className="md-modal-section-title">Tus listas</div>
            ...
            {loading ? (
              ...
              >
                No tienes listas todavia. Crea una debajo.
              </div>
            ) : (
              <div className="md-list-scroll-area">
                {lists.map((list) => (
                  ...
                  >
                    ...
                    >
                      {list.items_count} films{" "}
                      {list.is_public ? "· Publica" : "· Privada"}
                    </div>
                  </button>
                ))}
              </div>
          ...
          <div className="md-list-create-section">
            <div className="md-modal-section-title">Crear nueva lista</div>
