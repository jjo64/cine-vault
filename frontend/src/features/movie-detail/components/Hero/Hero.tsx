...
export function Hero({
  ...
  const directorLabel =
    mediaType === "tv" ? "Una serie creada por" : "Una película de";
    ...
    <div ref={heroRef} className="md-hero">
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(135deg, #0d1118 0%, #08090d 40%, #0a0c08 100%)",
        }}
      />
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(to right, rgba(8,8,8,0.9) 0%, rgba(8,8,8,0.78) 28%, rgba(8,8,8,0.5) 46%, rgba(8,8,8,0.2) 68%, rgba(8,8,8,0.04) 100%)",
        }}
      />
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 58% 70% at 24% 52%, rgba(8,8,8,0.5) 0%, rgba(8,8,8,0.24) 52%, rgba(8,8,8,0.06) 78%, transparent 100%)",
        }}
      />
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 42% 56% at 80% 42%, rgba(8,8,8,0.52) 0%, rgba(8,8,8,0.3) 34%, rgba(8,8,8,0.1) 64%, transparent 100%)",
        }}
      />
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse 36% 50% at 80% 42%, rgba(212,175,122,0.14) 0%, rgba(212,175,122,0.08) 34%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          height: 400,
          background:
            "radial-gradient(ellipse at bottom left, rgba(212,175,122,0.10), transparent 70%)",
          pointerEvents: "none",
        }}
      />
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(135deg, rgba(255,255,255,0.05) 0%, transparent 50%, rgba(0,0,0,0.25) 100%)",
              }}
            />
            <div
              style={{
      ...
      >
        ...
        <div className="md-title-block">
          ...
          {posterUrl && (
            <div className="md-hero-poster md-only-mobile">
              <div
                style={{
                  backgroundImage: `url(${TMDB_BASE}w500${posterPath})`,
        ...
        <div className="md-actions-row">
          <button
            ...
            style={{
              padding: "0 24px",
              background: inVault ? "#9A7A48" : "#D4AF7A",
              color: "#080808",
            }}
          >
          ...
          <div className="md-action-icons-row">
            <button
              ...
              style={{
                color: inWatchlist ? "#D4AF7A" : "#A1A1A1",
                border: `1px solid ${inWatchlist ? "#9A7A48" : "#252525"}`,
              }}
            >
              <Bookmark
                size={15}
            ...
            <button
              ...
              className="md-action-icon-btn"
              style={{
                color: liked ? "#D4AF7A" : "#A1A1A1",
                border: `1px solid ${liked ? "#9A7A48" : "#252525"}`,
              }}
            >
              <Heart
                size={15}
            ...
            <div ref={actionMenuRef} className="md-menu-wrapper">
              <button
                ...
                className="md-action-icon-btn"
                style={{
                  color: actionMenuOpen ? "#D4AF7A" : "#A1A1A1",
                  border: `1px solid ${actionMenuOpen ? "#9A7A48" : "#252525"}`,
                }}
              >
      ...
      <motion.div
        className="md-hero-scroll-prompt"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
