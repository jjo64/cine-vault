...
export function ActionBtn({
    ...
    icon: ReactNode; count?: number; active?: boolean;
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5, cursor: 'pointer' }}>
            <motion.button
                ...
                style={{
                    ...
                    cursor: 'pointer', color: active ? 'var(--color-accent)' : 'rgba(255,255,255,0.9)',
            ...
            {count !== undefined && (
                <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.85)', fontFamily: 'var(--font-sans)', letterSpacing: '0.04em' }}>
                    {fmtCount(count)}
                </span>
            )}
        </div>
