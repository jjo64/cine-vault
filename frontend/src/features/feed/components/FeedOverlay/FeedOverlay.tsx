...
export function ProgressDots({ total, active, onGo }: { total: number; active: number; onGo: (i: number) => void }) {
    return (
        <div style={{
...
export function NavArrows({ onUp, onDown, canUp, canDown }: { onUp: () => void; onDown: () => void; canUp: boolean; canDown: boolean }) {
    return (
        <div style={{
