        ...
        return (
          ...
          >
            <svg
              ...
              height={size}
              viewBox="0 0 12 12"
              fill="var(--color-text-muted, #b0b0b0)"
              style={{ display: "block" }}
            >
  ...
  return (
    <span
      style={{
        ...
        padding: "3px 8px",
        border: "1px solid var(--color-accent-dim, #9a7a48)",
  ...
  return (
    ...
    >
      ...
      >
        {title}{" "}
        {em && (
          <em style={{ color: "var(--color-text-soft, #a1a1a1)", fontStyle: "italic", fontSize: 22 }}>
            {em}
          </em>
        )}
      </div>
