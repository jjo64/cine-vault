...
const PERSON = {
  ...
  died: "29 dic. 1986",
  age: 54,
  birthplace: "Zavrazhye, URSS",
  nationality: "Soviético · Ruso",
  primaryRole: "Director",
  portrait:
    "https://images.unsplash.com/photo-1683797008263-cac0982c1dd7?w=800&q=85",
  heroBg:
    "https://images.unsplash.com/photo-1659933021944-d42680e82c80?w=1600&q=85",
  stats: { fans: 4821, inWatchlists: 28400, avgRating: 4.7, totalFilms: 7 },
  awards: [
    "León de Oro — Venecia 1962",
    "Premio del Jurado — Cannes 1980",
    "Premio FIPRESCI — Cannes 1980",
    "Premio especial — Cannes 1983",
  ],
  ...
  knownFor: [
    {
      title: "Stalker",
      year: 1979,
      img: "https://images.unsplash.com/photo-1648256289719-9ebbd79faaa5?w=400&q=80",
      id: "stalker",
      rating: 4.4,
    },
    {
      title: "Andrei Rublev",
      year: 1966,
      img: "https://images.unsplash.com/photo-1717446871833-dc6420252a30?w=400&q=80",
      id: "andrei-rublev",
      rating: 4.5,
    },
    {
      title: "El espejo",
      year: 1975,
      img: "https://images.unsplash.com/photo-1706460400799-bd339797d306?w=400&q=80",
      id: "el-espejo",
      rating: 4.3,
    },
    {
    ...
    },
    {
      title: "Nostalghia",
      year: 1983,
      img: "https://images.unsplash.com/photo-1767462587452-6a7fa99cc961?w=400&q=80",
      id: "nostalghia",
      rating: 4.3,
    },
    {
    ...
    director: [
      {
        ...
        genres: ["Drama", "Filosófico"],
        duration: "149 min",
        rating: 4.1,
        img: "https://images.unsplash.com/photo-1698159929266-28e8e8ef6b33?w=200&q=80",
        id: "el-sacrificio",
      },
      {
        year: 1983,
        ...
        duration: "126 min",
        rating: 4.3,
        img: "https://images.unsplash.com/photo-1767462587452-6a7fa99cc961?w=200&q=80",
        id: "nostalghia",
      },
      {
        year: 1979,
        ...
        duration: "162 min",
        rating: 4.4,
        img: "https://images.unsplash.com/photo-1648256289719-9ebbd79faaa5?w=200&q=80",
        id: "stalker",
      },
      {
        year: 1975,
        ...
        genres: ["Drama", "Autobiográfico"],
        duration: "108 min",
        rating: 4.3,
        img: "https://images.unsplash.com/photo-1706460400799-bd339797d306?w=200&q=80",
        id: "el-espejo",
      },
      {
        year: 1972,
        ...
        genres: ["Sci-fi", "Filosófico"],
        duration: "167 min",
        rating: 4.2,
        img: "https://images.unsplash.com/photo-1769121803735-59cde1085231?w=200&q=80",
        id: "solaris",
      },
      {
        year: 1966,
        ...
        duration: "205 min",
        rating: 4.5,
        img: "https://images.unsplash.com/photo-1717446871833-dc6420252a30?w=200&q=80",
        id: "andrei-rublev",
      },
      {
        year: 1962,
        title: "La infancia de Iván",
        originalTitle: "Иваново детство",
        genres: ["Drama", "Bélico"],
        duration: "95 min",
        rating: 4.2,
        img: "https://images.unsplash.com/photo-1770896689026-f5421714f6a5?w=200&q=80",
        id: "ivan-childhood",
      },
    ] as FilmCredit[],
    writer: [
  ...
  actor: [
    {
      ...
      originalTitle: "Каток и скрипка",
      role: "Cameo",
      secondary: true,
      genres: ["Cortometraje"],
      duration: "46 min",
      rating: 3.8,
      img: "https://images.unsplash.com/photo-1762948050110-76e67d7aae29?w=200&q=80",
      id: "katok",
    },
    {
      year: 1960,
      title: "Ubiytsy",
      originalTitle: "Убийцы",
      role: "Papel secundario",
      secondary: true,
      genres: ["Drama", "Cortometraje"],
      duration: "20 min",
      rating: 3.5,
      img: "https://images.unsplash.com/photo-1659933021944-d42680e82c80?w=200&q=80",
      id: "ubiytsy",
    },
  ] as FilmCredit[],
};
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(to right, rgba(8,8,8,0.98) 0%, rgba(8,8,8,0.82) 45%, rgba(8,8,8,0.3) 70%, transparent 100%)",
        }}
      />
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(to top, rgba(8,8,8,0.98) 0%, transparent 55%)",
        }}
      />
      {/* Accent glow */}
      <div
        style={{
          ...
          width: 500,
          height: 300,
          background: `radial-gradient(ellipse at bottom left, ${C.accentGlow}, transparent 70%)`,
          pointerEvents: "none",
        }}
      />
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to left, transparent 40%, rgba(8,8,8,0.9) 100%)",
          }}
        />
        <div
          style={{
      ...
      >
          ...
          {[
            {
              ...
              text: `${PERSON.born} — ${PERSON.died} · ${PERSON.age} años`,
            },
        ...
        >
          {[
            {
              num: PERSON.stats.fans.toLocaleString(),
              label: "Fans en CineVault",
            },
            {
              num: PERSON.stats.avgRating.toFixed(1) + "/5",
              label: "Rating medio",
            },
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {PERSON.awards.map((a, i) => (
          ...
          >
            ...
            <span
              style={{ fontFamily: SERIF, fontSize: 16, color: C.textSoft }}
            >
              {a}
            </span>
          </div>
    ...
    <Link to={`/film/${film.id}`} style={{ textDecoration: "none" }}>
      <motion.div
        ...
        style={{
          ...
          borderBottom: `1px solid ${C.border}`,
          cursor: "pointer",
          background: hov ? "rgba(212,175,122,0.03)" : "transparent",
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 10, color: C.textMuted, fontFamily: SANS }}>
            {film.duration}
          </div>
        </div>
      </motion.div>
...
const CREW_KEY: Record<CrewTab, "director" | "writer" | "producer"> = {
  Director: "director",
  Guionista: "writer",
  Productor: "producer",
};
...
function Filmography() {
  ...
  const filterByDecade = (films: FilmCredit[]) =>
    decade === "Todo"
      ? films
      : films.filter(
          (f) => f.year >= parseInt(decade) && f.year < parseInt(decade) + 10,
        );

  const displayed =
    careerTab === "crew" ? filterByDecade(crewFilms) : PERSON.actor;
        ...
        {(["crew", "actor"] as const).map((tab) => (
          <button
            ...
            style={{
              ...
              background: "none",
              border: "none",
              borderBottom: `2px solid ${careerTab === tab ? C.accent : "transparent"}`,
              fontFamily: SANS,
              fontSize: 12,
              letterSpacing: "0.16em",
              textTransform: "uppercase",
              color: careerTab === tab ? C.text : C.textSoft,
              cursor: "pointer",
              transition: "all 0.2s",
              marginBottom: -1,
            }}
          >
            {tab === "crew"
              ? `Crew (${PERSON.crew.director.length})`
              : `Actor (${PERSON.actor.length})`}
          </button>
        ))}
      </div>
            ...
            >
              <div style={{ display: "flex", gap: 8 }}>
                {CREW_TABS.map((t) => (
                  <button
                    key={t}
                    onClick={() => setCrewTab(t)}
                    style={{
                      padding: "6px 16px",
                      background: crewTab === t ? C.accentGlow : "transparent",
                      color: crewTab === t ? C.accent : C.textSoft,
                      border: `1px solid ${crewTab === t ? C.accentDim : C.border}`,
                      fontFamily: SANS,
                      fontSize: 10,
                      letterSpacing: "0.14em",
                      textTransform: "uppercase",
              ...
              <div style={{ display: "flex", gap: 6 }}>
                {decades.map((d) => (
                  <button
                    ...
                    style={{
                      padding: "4px 12px",
                      background: decade === d ? C.elevated : "transparent",
                      color: decade === d ? C.text : C.textMuted,
                      border: `1px solid ${decade === d ? C.border : "transparent"}`,
                      fontFamily: SANS,
                      fontSize: 10,
                      letterSpacing: "0.1em",
                      cursor: "pointer",
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {displayed.length === 0 ? (
            ...
            >
              Sin resultados para esta década.
            </div>
          ) : (
            displayed.map((film, i) => (
              <FilmRow
                key={film.id + i}
                film={film}
                crewRole={careerTab === "crew" ? crewTab : undefined}
              />
            ))
          )}
        </motion.div>
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "72px 52px 0" }}>
        <div
          style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: 72 }}
        >
          <main>
            <Bio />
            <KnownFor />
                  ...
                  {[
                    {
                      icon: <Users size={14} />,
                      label: "Fans",
                      val: PERSON.stats.fans.toLocaleString(),
                    },
                    {
                      icon: <Bookmark size={14} />,
                      label: "En watchlists",
                      val: PERSON.stats.inWatchlists.toLocaleString(),
                    },
                    {
                      icon: <Star size={14} />,
                      label: "Rating medio",
                      val: `${PERSON.stats.avgRating}/5`,
                    },
                  ].map((s, i) => (
                    <div
                      key={i}
